        ...
        <div className="containerRegistro p-4 overflow-y-scroll">
            <form class="wrapperRegistro p-5 pt-1 pb-1">
                ...
                <div className="form-group mb-2 p-2 d-block ">
                    <p className="w-100 mb-0">Nombre</p>
                ...
                <div className="form-group mb-2 p-2 d-block">
                    <p className="w-100 mb-0">Teléfono</p>
                ...
                <div className="form-group mb-2 p-2 d-block">
                    <p className="w-100 mb-0">Carnet de identidad</p>
                    <div className=" groupRegistro w-100">
                ...
                <div className="form-group mb-2 p-2 d-block">
                    <p className="w-100 mb-0">Vehículo</p>
                    <div className="w-100">
                        <div className=" groupRegistro w-100">
                ...
                <div className="form-group mb-2 p-2 d-block">
                    <p className="w-100 mb-0">Correo electrónico</p>
                    <div className=" groupRegistro w-100">
                ...
                <div className="form-group mb-2 p-2 d-block">
                    <p className="w-100 mb-0">Contraseña</p>
                    <div className=" groupRegistro w-100">
                ...
                <div className="w-100 row ms-1">
                    <button class="btn col-5 col-md-4 btn-block text-center my-3  rounded" onClick={()=>{navigate("/")}}>Cancelar</button>
                    <div className="col-md-4  col-2"></div>

                    <button class="btn btn-block col-5 col-md-4 text-center my-3 rounded me-0">Crear cuenta</button>
                </div>
            </form>
        </div>
    );
